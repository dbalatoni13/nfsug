...
struct CollisionObject {
  // total size: 0x70
  bVector::bVector4 fPosRadius;      // offset 0x0, size 0x10
  bVector::bVector4 fDimensions;     // offset 0x10, size 0x10
  ...
  bVector::bMatrix4 fMat;            // offset 0x30, size 0x40
};

struct CollisionInstance {
  // total size: 0x40
  bVector::bVector4 fInvMatRow0Width;                // offset 0x0, size 0x10
  ...
  bVector::bVector4 fInvMatRow2Length;               // offset 0x20, size 0x10
  bVector::bVector4 fInvPosRadius;                   // offset 0x30, size 0x10
};
